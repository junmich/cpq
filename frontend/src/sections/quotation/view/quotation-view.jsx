...
export default function QuotationPage() {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = quotations.map((n) => n.name);
  ...
  const handleNavigate = () => navigate('/quotation/create');
  ...
  return (
    <Container>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        ...
        <Button onClick={handleNavigate} variant="contained" color="inherit" startIcon={<Iconify icon="eva:plus-fill" />}>
          Create Quotation
        </Button>
      </Stack>
          ...
          <TableContainer sx={{ overflow: 'unset' }}>
            <Table sx={{ minWidth: 800 }}>
              <UserTableHead
                ...
                headLabel={[
                  { id: 'quotation_no', label: 'Quote No' },
                  { id: 'name', label: 'Name' },
