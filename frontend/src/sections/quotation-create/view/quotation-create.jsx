...
export default function QuotationPage() {
  ...
  const contactInfoInput = useRef(null);
  ...
  const handleSaveQuotation = () => {
    ...
    const contactInfo = contactInfoInput.current?.value;
  ...
  const handleRowEditCommit = (params) => {
    ...
    const updatedRows = rows.map((row) => {
      ...
      if (row.id === params.id) {
        ...
        updatedRow.total = ((updatedRow.quantity || 0) * (updatedRow.price || 0) - updatedRow.discount || 0);
